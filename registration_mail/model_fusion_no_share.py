...
class Agent(nn.Module):
    ...
    def __init__(self):
        ...
        self.actor_critic2d0 = ActorCriticHead2D()
        self.actor_critic2d1 = ActorCriticHead2D()
        self.actor_critic2d2 = ActorCriticHead2D()
        self.actor_critic2d3 = ActorCriticHead2D()
        self.actor_critic2d4 = ActorCriticHead2D()
        self.actor_critic2d5 = ActorCriticHead2D()
    ...
    def forward(self, src, tgt):
        ...
        #print("action_3d.shape, value_3d.shape:", action_3d[0].shape, value_3d[0].shape)
        #print("state_2d.shape: ", state_2d.shape)
        action_2d0, value_2d0 = self.actor_critic2d0(state_2d[:, 0, :])
        action_2d1, value_2d1 = self.actor_critic2d1(state_2d[:, 1, :])
        action_2d2, value_2d2 = self.actor_critic2d2(state_2d[:, 2, :])
        action_2d3, value_2d3 = self.actor_critic2d3(state_2d[:, 3, :])
        action_2d4, value_2d4 = self.actor_critic2d4(state_2d[:, 4, :])
        action_2d5, value_2d5 = self.actor_critic2d5(state_2d[:, 5, :])
        action_2d_t = action_2d0[0] + action_2d1[0]+action_2d2[0]+action_2d3[0]+action_2d4[0]+action_2d5[0]
        action_2d_r = action_2d0[1] + action_2d1[1]+action_2d2[1]+action_2d3[1]+action_2d4[1]+action_2d5[1]
        #print(value_2d.shape)
        action_2d = [action_2d_t, action_2d_r]
        value_2d = value_2d0 + value_2d1 +value_2d2+value_2d3+value_2d4+value_2d5
        #print("action_2d.shape, value_2d.shape:", action_2d[0].shape, value_2d[0].shape)
...
class ActorCriticHead2D(nn.Module):
