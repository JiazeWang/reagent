...
class Agent(nn.Module):
    ...
    def __init__(self):
        ...
        self.actor_critic2d = ActorCriticHead2D()
    ...
    def forward(self, src, tgt):
        ...
        action_2d[0] = torch.mean(action_2d[0], dim=1)
        action_2d[1] = torch.mean(action_2d[1], dim=1)
        value_2d = torch.mean(value_2d, dim=1)
