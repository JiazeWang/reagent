...
from registration_dense.model import Agent
import registration_dense.model as util_model
...
if __name__ == '__main__':
    ...
    if args.mode == "pretrain" and dataset == "m40":
        ...
        train(agent, logger, dataset, noise_type="clean", epochs=200, lr=1e-3, lr_step=40, alpha=2,
        ...
        epochs = 200 if dataset == "m40" else 200
        lr = 1e-4 if dataset == "m40" else 1e-3
        lr_step = 40 if dataset == "m40" else 40
