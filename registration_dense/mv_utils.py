...
def distribute(depth, _x, _y, size_x, size_y, image_height, image_width):
    ...
    return weighed_value_scattered,  weight_scattered, true_coordinates
...
def points2depth(points, image_height, image_width, size_x=4, size_y=4):
    ...
    weighed_value_scattered, weight_scattered, coordinates = distribute(
        depth=depth,
        _x=_x,
        _y=_y,
        size_x=size_x,
    ...
    return depth_recovered, coordinates
